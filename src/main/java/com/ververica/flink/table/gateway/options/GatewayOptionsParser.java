 ...
 */
public class GatewayOptionsParser {
	...
	public static final Option OPTION_PORT = Option
		.builder("p")
		.required(false)
		.longOpt("port")
		.numberOfArgs(1)
	...
	public static GatewayOptions parseGatewayOptions(String[] args) {
		try {
			...
			return new GatewayOptions(
				...
				port,
				checkUrl(line, GatewayOptionsParser.OPTION_DEFAULTS),
				checkUrls(line, GatewayOptionsParser.OPTION_JAR),
				checkUrls(line, GatewayOptionsParser.OPTION_LIBRARY)
			);
