...
/**
 * Tests for {@link UpdateOperation}.
 */
public class UpdateOperationTest extends OperationTestBase {

	@Test
	public void testCreateDatabase() {
		UpdateOperation operation = new UpdateOperation(context, "create database MyDatabase1");
