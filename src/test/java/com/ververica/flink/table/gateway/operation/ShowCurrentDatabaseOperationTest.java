...
/**
 * Tests for {@link ShowCurrentDatabaseOperation}.
 */
public class ShowCurrentDatabaseOperationTest extends OperationTestBase {
	...
	public void testShowCurrentDatabase() {
		...
		context.getExecutionContext().getTableEnvironment().useDatabase("default");
